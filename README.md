...
- [patchlevel/worker](https://github.com/patchlevel/worker) ([1.0.0](https://github.com/patchlevel/worker/releases/tag/1.0.0), 6 days ago) - With this library you can hydrate objects from array into objects and back again.
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.0.0](https://github.com/patchlevel/hydrator/releases/tag/1.0.0), 6 days ago) - With this library you can hydrate objects from array into objects and back again. 

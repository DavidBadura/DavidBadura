...
- [brainbits/functional-test-helpers](https://github.com/brainbits/functional-test-helpers) ([4.7.0](https://github.com/brainbits/functional-test-helpers/releases/tag/4.7.0), 3 days ago) - 
- [CuyZ/Valinor](https://github.com/CuyZ/Valinor) ([1.3.1](https://github.com/CuyZ/Valinor/releases/tag/1.3.1), 4 weeks ago) - PHP library that helps to map any input into a strongly-typed value object structure.

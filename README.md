...
- [patchlevel/event-sourcing-symfony](https://github.com/patchlevel/event-sourcing-symfony) -  (2 days ago)
...
- [patchlevel/worker](https://github.com/patchlevel/worker) ([1.4.0](https://github.com/patchlevel/worker/releases/tag/1.4.0), 3 weeks ago) - Gives the opportunity to build a stable worker that terminates properly when limits are exceeded.

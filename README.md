...
- [patchlevel/event-sourcing-psr-container](https://github.com/patchlevel/event-sourcing-psr-container) - patchlevel/event-sourcing factories for PSR-11 containers (3 days ago)
...
- [CuyZ/Valinor](https://github.com/CuyZ/Valinor) ([1.1.0](https://github.com/CuyZ/Valinor/releases/tag/1.1.0), 1 week ago) - PHP library that helps to map any input into a strongly-typed value object structure.

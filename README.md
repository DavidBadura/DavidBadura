...
- [CuyZ/Valinor](https://github.com/CuyZ/Valinor) ([1.3.0](https://github.com/CuyZ/Valinor/releases/tag/1.3.0), 1 day ago) - PHP library that helps to map any input into a strongly-typed value object structure.

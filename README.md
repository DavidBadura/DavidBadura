...
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.11.0](https://github.com/patchlevel/hydrator/releases/tag/1.11.0), 1 day ago) - This library enables seamless hydration of objects to arrays—and back again. It’s optimized for both developer experience (DX) and performance.
- [home-assistant/core](https://github.com/home-assistant/core) ([2025.6.0](https://github.com/home-assistant/core/releases/tag/2025.6.0), 2 days ago) - :house_with_garden: Open source home automation that puts local control and privacy first.

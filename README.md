...
- [CuyZ/Valinor](https://github.com/CuyZ/Valinor) ([1.0.0](https://github.com/CuyZ/Valinor/releases/tag/1.0.0), 3 weeks ago) - PHP library that helps to map any input into a strongly-typed value object structure.

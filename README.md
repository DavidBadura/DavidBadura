...
- [DavidBadura/Fixtures](https://github.com/DavidBadura/Fixtures) - A library to load yaml, json or php fixtures. Easy extendable, resolve object dependency and validate objects. (1 week ago)
...
- [DavidBadura/orangedb](https://github.com/DavidBadura/orangedb) - :orange_book: Super Fast Readonly Filesystem Database (1 month ago)

---

#### 🔭 Latest releases I've contributed to

- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([2.0.0-beta4](https://github.com/patchlevel/event-sourcing/releases/tag/2.0.0-beta4), 3 days ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal
- [DavidBadura/Fixtures](https://github.com/DavidBadura/Fixtures) ([1.3.2](https://github.com/DavidBadura/Fixtures/releases/tag/1.3.2), 1 week ago) - A library to load yaml, json or php fixtures. Easy extendable, resolve object dependency and validate objects.

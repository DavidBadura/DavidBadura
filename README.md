...
- [CuyZ/Valinor](https://github.com/CuyZ/Valinor) ([0.16.0](https://github.com/CuyZ/Valinor/releases/tag/0.16.0), 4 days ago) - PHP library that helps to map any input into a strongly-typed value object structure.
...
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([2.1.0-beta1](https://github.com/patchlevel/event-sourcing/releases/tag/2.1.0-beta1), 1 week ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal

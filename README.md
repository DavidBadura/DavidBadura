...
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([2.1.0-beta1](https://github.com/patchlevel/event-sourcing/releases/tag/2.1.0-beta1), 5 days ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal

...
- [DavidBadura/Fixtures](https://github.com/DavidBadura/Fixtures) - A library to load yaml, json or php fixtures. Easy extendable, resolve object dependency and validate objects. (6 days ago)
...
- [DavidBadura/Fixtures](https://github.com/DavidBadura/Fixtures) ([1.3.2](https://github.com/DavidBadura/Fixtures/releases/tag/1.3.2), 4 days ago) - A library to load yaml, json or php fixtures. Easy extendable, resolve object dependency and validate objects.

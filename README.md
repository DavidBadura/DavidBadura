...
- [patchlevel/rango](https://github.com/patchlevel/rango) ([1.0.0](https://github.com/patchlevel/rango/releases/tag/1.0.0), 4 days ago) - Rango is a high-performance PHP library that reimplements the MongoDB PHP API on top of PostgreSQL using the power of JSONB
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.23.1](https://github.com/patchlevel/hydrator/releases/tag/1.23.1), 6 days ago) - This library enables seamless hydration of objects to arrays—and back again. It’s optimized for both developer experience (DX) and performance.

...
- [DavidBadura/Fixtures](https://github.com/DavidBadura/Fixtures) - A library to load yaml, json or php fixtures. Easy extendable, resolve object dependency and validate objects. (1 day ago)
...
- [DavidBadura/Fixtures](https://github.com/DavidBadura/Fixtures) ([1.3.1](https://github.com/DavidBadura/Fixtures/releases/tag/1.3.1), 6 days ago) - A library to load yaml, json or php fixtures. Easy extendable, resolve object dependency and validate objects.

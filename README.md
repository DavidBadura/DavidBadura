...
- [DavidBadura/environment](https://github.com/DavidBadura/environment) -  (1 day ago)
...
- [CuyZ/Valinor](https://github.com/CuyZ/Valinor) ([1.2.0](https://github.com/CuyZ/Valinor/releases/tag/1.2.0), 3 days ago) - PHP library that helps to map any input into a strongly-typed value object structure.
- [patchlevel/event-sourcing-bundle](https://github.com/patchlevel/event-sourcing-bundle) ([2.1.0](https://github.com/patchlevel/event-sourcing-bundle/releases/tag/2.1.0), 3 weeks ago) - A lightweight but also all-inclusive event sourcing bundle with a focus on developer experience and based on doctrine dbal
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([2.1.0](https://github.com/patchlevel/event-sourcing/releases/tag/2.1.0), 3 weeks ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal

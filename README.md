...
- [patchlevel/hydrator](https://github.com/patchlevel/hydrator) ([1.3.2](https://github.com/patchlevel/hydrator/releases/tag/1.3.2), 1 day ago) - With this library you can hydrate objects from array into objects and back again. 
- [patchlevel/event-sourcing](https://github.com/patchlevel/event-sourcing) ([3.0.0-rc12](https://github.com/patchlevel/event-sourcing/releases/tag/3.0.0-rc12), 1 day ago) - A lightweight but also all-inclusive event sourcing library with a focus on developer experience and based on doctrine dbal

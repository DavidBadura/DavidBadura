...
- [patchlevel/worker](https://github.com/patchlevel/worker) ([1.1.1](https://github.com/patchlevel/worker/releases/tag/1.1.1), 2 days ago) - Gives the opportunity to build a stable worker that terminates properly when limits are exceeded.
